...
If you only need a transcript for notes, descriptions, or review, extract the text with [ASS to TXT](/tools/ass-to-txt/) instead of preparing a caption upload file.
