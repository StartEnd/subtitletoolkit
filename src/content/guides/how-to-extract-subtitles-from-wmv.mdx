...
If you already have a `.smi` or `.sami` file, open or convert that caption file directly instead of extracting from the WMV. If the captions are visible only in the video image, use OCR and review the result manually.
