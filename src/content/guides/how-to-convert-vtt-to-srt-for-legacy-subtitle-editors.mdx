---
title: How to convert VTT to SRT for legacy subtitle editors
description: Turn WebVTT caption files into SRT format for editors, archive workflows, and tools that do not support VTT natively.
pubDate: 2026-05-07
