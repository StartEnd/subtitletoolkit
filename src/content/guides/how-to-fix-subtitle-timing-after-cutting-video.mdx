...
seoTitle: Fix Subtitle Timing After Cutting Video - Scene Edits
seoDescription: Fix subtitle timing after trimming or cutting a video. Shift the whole file or only cues after a scene edit locally with no upload.
