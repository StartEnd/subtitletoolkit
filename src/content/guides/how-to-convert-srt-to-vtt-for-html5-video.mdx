...
If the next step does not need subtitle timing at all, use the [SRT to TXT Converter](/tools/srt-to-txt/) instead. That keeps the readable subtitle text and removes cue numbers plus timestamp lines.
