...
seoTitle: Name Subtitle Files for Plex - SRT Language Codes
seoDescription: Name Plex subtitle files by matching the video filename, adding language codes, choosing SRT when needed, and refreshing the library.
