...
Latest production gate: `pnpm verify:gsc:submit-ready` passed on 2026-06-02 against the live `0f8c4fa` deployment (`sitemap-0.xml` lastmod `2026-06-02T08:26:23.000Z`) using the same local verifier commit. The primary queue below has 21 URL Inspection requests; the current queue has 157 URLs. Keep them unchecked until the manual Search Console requests are actually submitted.
...
- [ ] `https://subtitletoolkit.tools/guides/how-to-extract-srt-from-mkv/`
...
- [ ] `https://subtitletoolkit.tools/guides/how-to-convert-xml-subtitles-to-srt/`
...
- [ ] `https://subtitletoolkit.tools/guides/how-to-convert-subviewer-to-srt/`
- [ ] `https://subtitletoolkit.tools/guides/how-to-convert-mpl2-to-srt/`
- [ ] `https://subtitletoolkit.tools/guides/how-to-convert-csv-to-srt/`
- [ ] `https://subtitletoolkit.tools/guides/how-to-convert-json-to-srt/`
...
- [ ] `https://subtitletoolkit.tools/guides/how-to-merge-subtitle-files/`
...
- [ ] `https://subtitletoolkit.tools/tools/srt-to-ssa/`
- [ ] `https://subtitletoolkit.tools/tools/vtt-to-ssa/`
...
- [ ] `https://subtitletoolkit.tools/tools/xml-to-srt/`
...
- [ ] `https://subtitletoolkit.tools/tools/subviewer-to-srt/`
- [ ] `https://subtitletoolkit.tools/tools/mpl2-to-srt/`
- [ ] `https://subtitletoolkit.tools/tools/csv-to-srt/`
- [ ] `https://subtitletoolkit.tools/tools/json-to-srt/`
