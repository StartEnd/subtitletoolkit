...
Latest production gate: `pnpm verify:gsc:submit-ready` passed on 2026-06-01 for commit `b5681c0`. The primary queue below has 21 URL Inspection requests; keep it unchecked until the manual Search Console requests are actually submitted.
